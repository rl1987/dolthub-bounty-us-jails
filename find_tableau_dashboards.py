...
def main():
    ...
    for state in us.STATES:
        q = "site:public.tableau.com inurl:views (inmate OR jail OR prison) AND population AND ({} or {}) -\"Category Management\" -Killing -PoliceViolencebyState -Funding -NVWT -\"Police Violence\" -Netflix".format(state.name, state.abbr)
        ...
        resp = requests.get("http://www.google.com/search", params=params, proxies=proxies)
        print(resp.url)
