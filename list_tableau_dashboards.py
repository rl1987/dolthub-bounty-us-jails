...
def main():
    ...
    while True:
        ...
        response = requests.get('https://public.tableau.com/profile/api/search/query', params=params, headers=headers)
        print(response.url)
        ...
        for result_dict in json_dict.get("results", []):
            ...
            url = "https://public.tableau.com/app/profile/{}/viz/{}".format(workbook_dict.get("authorProfileName"), workbook_dict.get("defaultViewRepoUrl"))
